...
@section('contents')
    ...
    <form action="{{url('/')}}/create-type-payment/next" method="post">
        @csrf
        <div class="card card-success m-2">
            <div class="card-header">
                <h3 class="card-title">รายการรูปแบบหรือประเภทการจายเงินของคุณมีกี่แบบ</h3>
            ...
            <div class="col-4">
                <div class="card card-solid">
                    ...
                    <div class="card-body pb-0" >
                        <form action="{{url('/')}}/create-type-payment" method="post">
                            @csrf
